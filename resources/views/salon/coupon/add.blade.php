                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group @error('code') has-danger @enderror ">
                                        <input autocomplete="off" class="form-control @error('fname') is-invalid @enderror" name="code" type="text" placeholder="{{__('file.code')}}" value="{{old('code')}}" />
                                        @if ($errors->has('code'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" type="text" placeholder="{{__('file.description')}}" value="{{old('description')}}" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('max_use') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('max_use') ? ' is-invalid' : '' }}" name="max_use" type="text" placeholder="{{__('file.max_use')}}" value="{{old('description')}}" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input discount_option_no" type="radio" name="discount_option" id="inlineRadio1" value="p">
                                        <label class="form-check-label" for="inlineRadio1">{{__('file.percentage')}}</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input discount_option_yes  " {{old('discount_option') == '1' ? 'checked' : ''}} type="radio" name="discount_option" id="inlineRadio2" value="a">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('start_date') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('start_date') ? ' is-invalid' : '' }}" name="start_date" type="date" placeholder="{{__('file.start_date')}}" value="{{old('start_date')}}" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('end_date') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('end_date') ? ' is-invalid' : '' }}" name="end_date" type="date" placeholder="{{__('file.end_date')}}" value="{{old('end_date')}}" />
