            ...
            <div class="card">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="{{route('salon.service')}}">{{__('file.all')}} {{__('file.services')}}</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group @error('service_name') has-danger @enderror ">
                                        <input autocomplete="off" class="form-control @error('fname') is-invalid @enderror" name="service_name" type="text" placeholder="{{__('file.enter_service_name')}}" value="{{$service->service_name}}" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('service_price') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('service_price') ? ' is-invalid' : '' }}" name="service_price" type="text" placeholder="{{__('file.enter_service_price')}}" value="{{$service->service_price}}" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input discount_option_no" type="radio" @if($service->is_discount==0) checked @endif name="discount_option" id="inlineRadio1" value="0">
                                        <label class="form-check-label" for="inlineRadio1">{{__('file.no_discount')}}</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input discount_option_yes  " {{old('discount_option') == '1' ? 'checked' : ''}} @if($service->is_discount==1) checked @endif type="radio" name="discount_option" id="inlineRadio2" value="1">
                            ...
                            <div class="row is_discount" style="display:none;">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('discount') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('discount') ? ' is-invalid' : '' }}" name="discount" type="text" placeholder="{{__('file.discount')}}" value="{{old('discount')}} @if($service->is_discount==1) {{$service->discount}}   @endif" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('service_time') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('service_time') ? ' is-invalid' : '' }}" name="service_time" type="text" placeholder="{{__('file.enter_service_time')}}" value="{{$service->service_time}} " />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img id="profile-img-tag" src="{{url('uploads/services')}}/{{$service->image}}" style="width: 50px;height:50px;" style="display: none;">
