        ...
        <div class="col-md-10 offset-md-1">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped border mt-5 pt-5 myTable text-center" id="">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img class="rounded" src="{{url('uploads/galleries')}}/{{$gallery->image}}" style="width: 100px; height:100px" alt=""></td>
                                <td><label class="switch">
                                        <input data-id='{{$gallery->id}}' class="status_checkbox" name="status" type="checkbox" @if($gallery->status==1) checked @endif>
                                        <span class="slider round"></span>
                                    </label></td>
                                <!-- <td><a href="#" class="editCountry" data-id="{{$gallery->id}}"><i class="material-icons text-warning fa-1x">mode_edit</i></a>
                                </td> -->
                            </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="modal-form create" action="{{route('gallery')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
